...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.background_image = pygame.image.load('/home/kali/Desktop/final.python/templates/home.jpg')
    ...
    def run_game(self):
        """Strart the mail loop for the game"""
        while True:
            self._check_events()
    ...
    def _check_events(self):
        ...
        #Watch for keybpard and mouse events.
    ...
    def _create_fleet(self):
        ...
        #spacing between each alien is to one alein width
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any aliens have reached aan edge"""
    ...
    def _update_aliens(self):
        """Check of the fleet's at the edge and update the positions of all aliens in the fleet"""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
           #Decrement ships_left, update the sb
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.alien:
            #Destroy system bullets and create new fleet
            self.bullets.empty()
            self._create_fleet()
